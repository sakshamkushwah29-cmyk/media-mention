      ...
      <div className="container1440 hero-inside">
        ...
        <div className="subheading-cta-holder">
          ...
          <div className="buttonholder">
            <a href="https://calendly.com/workmediamansion/30min" target="_blank" rel="noopener noreferrer" className="button big w-inline-block">
              <div className="button-inner p3_small herowhite">
      ...
      <div className="container1440 trustedby">
        <div className="mainusp-holder trustedbytxt">
          <h1 words-slide-from-right="" text-split="" className="mainusp trusted-by-text" style={{ color: '#282829' }}>
            TRUSTED BY MORE THAN <span style={{ color: '#9762fd', fontFamily: 'inherit', fontWeight: 'inherit' }}>100</span> CLIENTS INCLUDIN&#39; MARKETING AGENCIES, STARTUPS AND CREATORS
          </h1>
        </div>
        <div className="subheading-cta-holder">
          <div className="subheading-holder">
          ...
          <div className="uui-padding-vertical-xhuge-2">
            <div className="uui-testimonial16_component-2" ref={testimonialRef}>
              ...
              <div className="uui-testimonial16_content-2 black">
                ...
                <div className="uui-heading-xxsmall-2 text-weight-medium white">
                  Media Mansion brings pure magic to every campaign! Their team took our vision, elevated it beyond what we imagined, and delivered a brand identity that truly stands out in a crowded market. Responsive, visionary, and extremely fun to work with!
                </div>
                <div className="uui-testimonial16_client-2">
                  <div className="uui-testimonial16_client-image-wrapper-2">
                    <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=200&auto=format&fit=crop" loading="lazy" alt="Rohan Kapoor" className="uui-testimonial16_customer-image-2" style={{ width: '48px', height: '48px', borderRadius: '50%', objectFit: 'cover' }} />
                  </div>
                  <div className="uui-testimonial16_client-info-2">
                    <div className="uui-testimonial16_client-heading-2 white">
                      Rohan Kapoor
              ...
              <div className="uui-testimonial16_content-2">
                ...
                <div className="uui-heading-xxsmall-2 text-weight-medium">
                  The speed and quality of work from Media Mansion is unmatched. They handled our multi-channel ad campaigns and video assets seamlessly, boosting our conversion rates by 45% in the first month alone!
                </div>
                <div className="uui-testimonial16_client-2">
                  <div className="uui-testimonial16_client-image-wrapper-2">
                    <img src="https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=200&auto=format&fit=crop" loading="lazy" alt="Priya Nair" className="uui-testimonial16_customer-image-2" style={{ width: '48px', height: '48px', borderRadius: '50%', objectFit: 'cover' }} />
                  </div>
                  <div className="uui-testimonial16_client-info-2">
                    <div className="uui-testimonial16_client-heading-2">
                      Priya Nair
